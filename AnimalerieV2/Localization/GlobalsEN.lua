...
T[ "PluginHelp2" ] = "/AnV2 show Display the pet shop\n";
T[ "PluginHelp3" ] = "/AnV2 hide Hide the pet shop\n";
T[ "PluginHelp4" ] = "/AnV2 default Fills with base pets\n";
T[ "PluginHelp5" ] = "/AnV2 lock To lock or unlock the icons\n";
T[ "PluginHelp6" ] = "/AnV2 alt - Enables or disables the alt key for icon movement.\n";
T[ "PluginHelp7" ] = "/AnV2 toggle - Show or hide the window.\n";
T[ "PluginHelp8" ] = "/AnV2 clear Clear all hotkeys\n\n";
